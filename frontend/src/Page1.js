  ...
  return (
    <div className="whole-screen-center">
      <div className="d-flex align-items-center flex-column p-5 border border-white">
        ...
        <p className="subtitle-text text-center mt-2">
          You will be lead to a page with a dashboard for controlling the UFM.
          You may use the{" "}
          <b style={{ fontWeight: 900 }}>
            A, S, W and D keys for moving left, up, down and right respectively
          </b>{" "}
          of your keyboard in order to point the head of the UFM.
        </p>

        <br />
        <p className="subtitle-text text-center">
          Please view the following page on a desktop computer!
        </p>

        <br />
        <h2 className="title-text text-center">GOOD LUCK!</h2>
        <Link to="/dashboard" className="d-block mt-2 btn btn-info">
